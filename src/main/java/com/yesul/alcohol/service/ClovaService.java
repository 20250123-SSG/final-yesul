...
public class ClovaService {
    ...
    public String callClovaAPI(ClovaAskRequestDto askDto) {
        String url = "https://clovastudio.stream.ntruss.com/testapp/v1/skillsets/fv46jc9v/versions/17/final-answer";

        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        headers.set("Authorization", "Bearer nv-ae4562f3d5a54905a8ae4563a0ad9ce7eYf5");
        headers.set("X-NCP-CLOVASTUDIO-REQUEST-ID", "4cbca115b1b94c61bc0120bfc73458dc");
